                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label class="mt-3"><?php echo e(__('VIP 6 Reward Amount')); ?></label>
                                        <div class="input-group">
                                            <input type="text" name="vip6_rwd_limit" placeholder="<?php echo app('translator')->get('VIP 6 Reward Amount'); ?>"
                                               value="<?php echo e($general->vip6_reward_amount); ?>" class="form-control form_control">
                                        </div>
                                    </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\quantum\core\resources\views/backend/setting/general_setting.blade.php ENDPATH**/ ?>