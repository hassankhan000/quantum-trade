                ...
                <div class="row flex-row-reverse">
                    <div class="col-lg-3">
                        <div class="hero-thumb alltuchtopdown">
                            <img src="{{ asset('asset/theme4/web_assets/assets/img/update/hero/hero-1-1.jpg') }}"
                                alt="img">
                        </div>
                    </div>
                    <div class="col-lg-9">
                ...
                <div class="row g-0 brand-active2">
                    <div class="col-12">
                        <div class="brand-item">
                            <img src="{{ asset('asset/theme4/web_assets/assets/img/brand/brand_img01.png') }}"
                                alt="">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="brand-item">
                            <img src="{{ asset('asset/theme4/web_assets/assets/img/brand/brand_img02.png') }}"
                                alt="">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="brand-item">
                            <img src="{{ asset('asset/theme4/web_assets/assets/img/brand/brand_img03.png') }}"
                                alt="">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="brand-item">
                            <img src="{{ asset('asset/theme4/web_assets/assets/img/brand/brand_img04.png') }}"
                                alt="">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="brand-item">
                            <img src="{{ asset('asset/theme4/web_assets/assets/img/brand/brand_img05.png') }}"
                                alt="">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="brand-item">
                            <img src="{{ asset('asset/theme4/web_assets/assets/img/brand/brand_img06.png') }}"
                                alt="">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="brand-item">
                            <img src="{{ asset('asset/theme4/web_assets/assets/img/brand/brand_img07.png') }}"
                                alt="">
                        </div>
                    </div>
                    <div class="col-12">
                ...
                <div class="row gy-5">
                    ...
                    <div class="col-lg-5">
                        <div class="wcu-thumb text-center alltuchtopdown">
                            <img src="{{ asset('asset/theme4/web_assets/assets/img/update/normal/why_1-1.png') }}"
                                alt="img">
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-xl-6">
                    <div class="intro-thumb1 alltuchtopdown">
                        <img src="{{ asset('asset/theme4/web_assets/assets/img/update/normal/intro_1-1.png') }}"
                            alt="img">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row gy-30">
                <div class="col-lg-3 col-md-6">
                    <div class="invest-card">
                        <div class="invest-card-icon">
                            <img src="{{ asset('asset/theme4/web_assets/assets/img/update/invest/invest-icon-1.png') }}"
                                alt="icon">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="invest-card">
                        <div class="invest-card-icon">
                            <img src="{{ asset('asset/theme4/web_assets/assets/img/update/invest/invest-icon-2.png') }}"
                                alt="icon">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="invest-card">
                        <div class="invest-card-icon">
                            <img src="{{ asset('asset/theme4/web_assets/assets/img/update/invest/invest-icon-3.png') }}"
                                alt="icon">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="invest-card">
                        <div class="invest-card-icon">
                            <img src="{{ asset('asset/theme4/web_assets/assets/img/update/invest/invest-icon-4.png') }}"
                                alt="icon">
                        </div>
            ...
            <div class="container">
                ...
                <div class="row gy-4 justify-content-center">
                    <div class="col-lg-6">
                        <div class="founder-card">
                            <div class="founder-card-img">
                                <img src="{{ asset('asset/theme4/web_assets/assets/img/update/team/founder-1-1.png') }}"
                                    alt="img">
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="founder-card">
                            <div class="founder-card-img">
                                <img src="{{ asset('asset/theme4/web_assets/assets/img/update/team/founder-1-2.png') }}"
                                    alt="img">
                            </div>
                            <div class="founder-card-details">
                            ...
                            <ul class="team-tab-list">
                                <li>
                                    <div class="team-card">
                                        <div class="team-card_img">
                                            <img
                                                src="{{ asset('asset/theme4/web_assets/assets/img/update/team/team-1-1.png') }}">
                                            <div class="social-btn">
                                                <a href="https://www.linkedin.com/">
                                                    <i class="fab fa-linkedin"></i>
                                                </a>
                                ...
                                <li>
                                    <div class="team-card">
                                        <div class="team-card_img">
                                            <img
                                                src="{{ asset('asset/theme4/web_assets/assets/img/update/team/team-1-2.png') }}">
                                            <div class="social-btn">
                                                <a href="https://www.linkedin.com/">
                                                    <i class="fab fa-linkedin"></i>
                                                </a>
                                ...
                                <li>
                                    <div class="team-card">
                                        <div class="team-card_img">
                                            <img
                                                src="{{ asset('asset/theme4/web_assets/assets/img/update/team/team-1-3.png') }}">
                                            <div class="social-btn">
                                                <a href="https://www.linkedin.com/">
                                                    <i class="fab fa-linkedin"></i>
                                                </a>
                                ...
                                <li>
                                    <div class="team-card">
                                        <div class="team-card_img">
                                            <img
                                                src="{{ asset('asset/theme4/web_assets/assets/img/update/team/team-1-4.png') }}">
                                            <div class="social-btn">
                                                <a href="https://www.linkedin.com/">
                                                    <i class="fab fa-linkedin"></i>
                                                </a>
                                ...
                                <li>
                                    <div class="team-card">
                                        <div class="team-card_img">
                                            <img
                                                src="{{ asset('asset/theme4/web_assets/assets/img/update/team/team-1-5.png') }}">
                                            <div class="social-btn">
                                                <a href="https://www.linkedin.com/">
                                                    <i class="fab fa-linkedin"></i>
                                                </a>
                                ...
                                <li>
                                    <div class="team-card">
                                        <div class="team-card_img">
                                            <img
                                                src="{{ asset('asset/theme4/web_assets/assets/img/update/team/team-1-6.png') }}">
                                            <div class="social-btn">
                                                <a href="https://www.linkedin.com/">
                                                    <i class="fab fa-linkedin"></i>
                                                </a>
                                ...
                                <li>
                                    <div class="team-card">
                                        <div class="team-card_img">
                                            <img
                                                src="{{ asset('asset/theme4/web_assets/assets/img/update/team/team-1-7.png') }}">
                                            <div class="social-btn">
                                                <a href="https://www.linkedin.com/">
                                                    <i class="fab fa-linkedin"></i>
                                                </a>
                                ...
                                <li>
                                    <div class="team-card">
                                        <div class="team-card_img">
                                            <img
                                                src="{{ asset('asset/theme4/web_assets/assets/img/update/team/team-1-8.png') }}">
                                            <div class="social-btn">
                                                <a href="https://www.linkedin.com/">
                                                    <i class="fab fa-linkedin"></i>
                                                </a>
                                ...
                                <li>
                                    <div class="team-card">
                                        <div class="team-card_img">
                                            <img
                                                src="{{ asset('asset/theme4/web_assets/assets/img/update/team/team-1-9.png') }}">
                                            <div class="social-btn">
                                                <a href="https://www.linkedin.com/">
                                                    <i class="fab fa-linkedin"></i>
                                                </a>
                                ...
                                <li>
                                    <div class="team-card">
                                        <div class="team-card_img">
                                            <img
                                                src="{{ asset('asset/theme4/web_assets/assets/img/update/team/team-1-10.png') }}">
                                            <div class="social-btn">
                                                <a href="https://www.linkedin.com/">
                                                    <i class="fab fa-linkedin"></i>
                                                </a>
                ...
                <div class="row gy-60 gx-30 justify-content-center">
                    <div class="col-lg-3 col-md-6">
                        <div class="event-card">
                            <div class="event-card-img">
                                <a href="#">
                                    <img src="{{ asset('asset/theme4/web_assets/assets/img/update/event/1-1.png') }}">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="event-card">
                            <div class="event-card-img">
                                <a href="#">
                                    <img src="{{ asset('asset/theme4/web_assets/assets/img/update/event/1-2.png') }}">
                                </a>
                            </div>
                            <div class="event-card-content">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="event-card">
                            <div class="event-card-img">
                                <a href="#">
                                    <img src="{{ asset('asset/theme4/web_assets/assets/img/update/event/1-3.png') }}">
                                </a>
                            </div>
                            <div class="event-card-content">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="event-card">
                            <div class="event-card-img">
                                <a href="#">
                                    <img src="{{ asset('asset/theme4/web_assets/assets/img/update/event/1-4.png') }}">
                                </a>
                            </div>
                            <div class="event-card-content">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="event-card">
                            <div class="event-card-img">
                                <a href="#">
                                    <img src="{{ asset('asset/theme4/web_assets/assets/img/update/event/1-5.png') }}">
                                </a>
                            </div>
                            <div class="event-card-content">
                                <h4 class="event-card-title"><a href="contact.html">Blockchain summit</a></h4>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="event-card">
                            <div class="event-card-img">
                                <a href="#">
                                    <img src="{{ asset('asset/theme4/web_assets/assets/img/update/event/1-6.png') }}">
                                </a>
                            </div>
                            <div class="event-card-content">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="event-card">
                            <div class="event-card-img">
                                <a href="#">
                                    <img src="{{ asset('asset/theme4/web_assets/assets/img/update/event/1-7.png') }}">
                                </a>
                            </div>
                            <div class="event-card-content">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="event-card">
                            <div class="event-card-img">
                                <a href="#">
                                    <img src="{{ asset('asset/theme4/web_assets/assets/img/update/event/1-8.png') }}">
                                </a>
                            </div>
                            <div class="event-card-content">
                    ...
                    <div class="col-lg-6">
                        <div class="cta-wrap1">
                            ...
                            <div class="cta-wrap-details">
                                ...
                                <p class="cta-wrap-text">{{ @$element->data->answer }}</p>
            ...
            <div class="row gy-40 justify-content-between">
                <div class="col-xl-4 text-xl-start">
                    ...
                    <div class="faq-thumb mt-60">
                        <img src="{{ asset('asset/theme4/web_assets/assets/img/update/normal/faq_1-1.png') }}"
                            alt="img">
                    </div>
                </div>
