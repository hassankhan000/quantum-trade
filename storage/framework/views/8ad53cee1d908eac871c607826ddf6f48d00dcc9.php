                    ...
                    <div class="components-preview">
                        <div class="nk-block-head nk-block-head-lg wide-sm">
                            <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
                                ...
                                <a href="<?php echo e(route('user.dashboard')); ?>" class="back-btn"><i class="bi bi-arrow-left"></i>
                                    <?php echo e(__('Back')); ?></a>
                            </div>

                            <div class="d-flex flex-wrap justify-content-between mb-3">
                                <h5><?php echo e(__('Profile Setting')); ?></h5>
                                <a href="<?php echo e(route('user.change.password')); ?>" class="cmn-btn mb-2 sp_text_dark"><i
                                            ...
                                            <div class="col-md-4 pe-lg-5 pe-md-4 justify-content-center">
                                                <div class="img-choose-div">
                                                    ...
                                                    <label for="imageUpload"
                                                        class="editImg btn main-btn w-100"><span><?php echo e(__('Choose file')); ?></span></label>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="update">
                                                ...
                                                <button
                                                    class="btn main-btn mt-3 btn-primary"><span><?php echo e(__('Update')); ?></span></button>
                                            </div>
                                    </form>
                                </div>
                            </div>
...
<?php echo $__env->make(template() . 'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\quantum-trade\core\resources\views/theme4/user/profile.blade.php ENDPATH**/ ?>