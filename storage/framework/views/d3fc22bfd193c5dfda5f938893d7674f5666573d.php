                        ...
                        <form action="<?php echo e(route('user.forgot.password')); ?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap"><input type="email" class="form-control form-control-lg"
                                        name="email" id="email" placeholder="<?php echo e(__('Enter Email')); ?>"></div>
                            </div>
...
<?php echo $__env->make(template() . 'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u474401954/domains/quantummtradeai.com/public_html/core/resources/views/theme4/user/auth/forgot_password.blade.php ENDPATH**/ ?>