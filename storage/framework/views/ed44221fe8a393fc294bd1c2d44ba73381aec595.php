                            ...
                            <div class="col-md-6 col-xxl-4">
                                <ul class="timeline">
                                    ...
                                    <li>
                                        <div class="direction-r">
                                            <div class="flag-wrapper">
                                                ...
                                                <span class="time-wrapper"><span class="text-dark time"><?php echo e(round($SumLvlOneDepositAmnt->total_amount , 2)); ?></span></span>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <span class="time-wrapper"><span class="text-dark time"><?php echo e(count($LvlOneUsers)); ?></span></span>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="direction-r">
                                            <div class="flag-wrapper">
                                                ...
                                                <span class="time-wrapper"><span class="text-dark time"><?php echo e(round($SumLvlTwoDepositAmnt->total_amount , 2)); ?></span></span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="direction-r">
                                            <div class="flag-wrapper">
                                                ...
                                                <span class="time-wrapper"><span class="text-dark time"><?php echo e(count($LvlTwoUsers)); ?></span></span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="direction-r">
                                            <div class="flag-wrapper">
                                                ...
                                                <span class="time-wrapper"><span class="text-dark time"><?php echo e(round($SumLvlThreeDepositAmnt->total_amount , 2)); ?></span></span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="direction-r">
                                            <div class="flag-wrapper">
                                                ...
                                                <span class="time-wrapper"><span class="text-dark time"><?php echo e(count($LvlThreeUsers)); ?></span></span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="direction-r">
                                            <div class="flag-wrapper">
                                                ...
                                                <span class="time-wrapper"><span class="time bg-dark text-light"><?php echo e(round($TotalTeamDeposit , 2)); ?></span></span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="direction-r">
                                            <div class="flag-wrapper">
                                                ...
                                                <span class="time-wrapper"><span class="time bg-dark text-light"><?php echo e($TotalTeamMembers); ?></span></span>
                                            </div>
                                        </div>
                                    </li>
