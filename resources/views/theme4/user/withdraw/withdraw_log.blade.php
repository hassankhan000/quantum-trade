            ...
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    <div class="components-preview">
                        ...
                        <div class="tab-btn-group">
                            <a class="tab-btn m-3 {{ Request::routeIs('user.withdraw.all') ? 'active' : '' }}"
                                href="{{ route('user.withdraw.all') }}">{{ __('All') }} <span
                                    class="d-sm-inline-block d-none">{{ __('Withdraw') }}</span></a>

                            <a class="tab-btn m-3 {{ Request::routeIs('user.withdraw.pending') ? 'active' : '' }}"
                                href="{{ route('user.withdraw.pending') }}">{{ __('Pending') }} <span
                                    class="d-sm-inline-block d-none">{{ __('Withdraw') }}</span></a>

                            <a class="tab-btn m-3 {{ Request::routeIs('user.withdraw.complete') ? 'active' : '' }}"
