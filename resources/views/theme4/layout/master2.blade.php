...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('asset/theme4/dashboard_assets/assets/css/Quantume5ca.css') }}" />
                        ...
                        <div class="nk-header-menu" data-content="headerNav">
                            ...
                            <ul class="nk-menu nk-menu-main ui-s2">
                                <li class="nk-menu-item has-sub">
                                    <a href="{{ url('/dashboard') }}" class="nk-menu-link"><span
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{ url('investmentplan') }}" class="nk-menu-link"><span
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{ url('deposit') }}" class="nk-menu-link"><span
                                                    class="nk-menu-text">Deposit</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('deposit/log') }}" class="nk-menu-link"><span
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{ url('withdraw') }}" class="nk-menu-link"><span
                                                    class="nk-menu-text">Withdraw</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('withdraw/all') }}" class="nk-menu-link"><span
                                    ...
                                    <div
                                        ...
                                        <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                            <div class="user-card">
                                                ...
                                                <div class="user-info">
                                                    <span
                                                        class="lead-text">{{ auth()->user()->full_name }}</span><span
